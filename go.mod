...
require (
	github.com/RedHatInsights/sources-api-go v0.0.0-20240126184154-188f91863eb6
...
require (
	...
	github.com/RedHatInsights/tenant-utils v0.0.0-20220322192943-150a1a665a5f // indirect
